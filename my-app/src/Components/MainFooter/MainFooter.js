...
const MainFooter = () => {
  ...
  const inputCheck = () => {
    ...
    if (name.length == 0) {
      ...
      document.querySelector('.input-name').style.border = '1px solid white'
    }
    if (email.length == 0) {
      document.querySelector('.input-email').style.border = '1px solid red';
      ifRed = false;
    } else {
      document.querySelector('.input-email').style.border = '1px solid white'
    }
    if (choose.length == 0) {
      document.querySelector('.input-choose').style.border = '1px solid red';
      ifRed = false;
    } else {
      document.querySelector('.input-choose').style.border = '1px solid white'
    }
      ...
      <div className="mainf-sec">
        <div className='mainf-sec-col-1'>
          ...
          <div className='input-2'>
            ...
            <span>@</span>
            <input placeholder='CHOOSE' list='browsers' className='input-choose' type='text' onChange={e => {
          ...
          {/* <a href='#!'  className="mainf-sec-col-1-send-btn">Send</a> */}
